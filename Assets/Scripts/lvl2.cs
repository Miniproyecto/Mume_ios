...
public class lvl2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(activePer1 && activePer2 && activePer3 && activePer4 && activePer5 && reproducir_secuencia) // si todos los botones estan encendidos podemos proceder a reproducir la lista
        {
    ...
    {
        if( activePer2 && activePer3 && activePer4 && activePer5 &&  !reproducir_secuencia)
        {
    ...
    {
        if (activePer1 && activePer3 && activePer4 && activePer5 && !reproducir_secuencia) //if para que no pueda presionar mas de un boton al mismo tiempo 
        {
    ...
    {
        if (activePer2 && activePer1 && activePer4 && activePer5 && !reproducir_secuencia)//if para que no pueda presionar mas de un boton al mismo tiempo 
        {
    ...
    {
        if (activePer2 && activePer3 && activePer1 && activePer5 && !reproducir_secuencia)
        {
    ...
    {
        if (activePer2 && activePer3 && activePer1 && activePer4 && !reproducir_secuencia)
        {
