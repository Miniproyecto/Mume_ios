...
public class ModoPrueba : MonoBehaviour
{
    ...
    {
        if( activePer2 && activePer3 && activePer4 && activePer5 && activePer6 )
        {
    ...
    {
        if (activePer1 && activePer3 && activePer4 && activePer5 && activePer6 ) //if para que no pueda presionar mas de un boton al mismo tiempo 
        {
    ...
    {
        if (activePer2 && activePer1 && activePer4 && activePer5 && activePer6 )//if para que no pueda presionar mas de un boton al mismo tiempo 
        {
    ...
    {
        if (activePer2 && activePer3 && activePer1 && activePer5 && activePer6 )
        {
    ...
    {
        if (activePer2 && activePer3 && activePer1 && activePer4 && activePer6 )
        {
    ...
    {
        if (activePer2 && activePer3 && activePer1 && activePer4 && activePer5 )
        {
